    ...
    def test_decompress_lb_monitoring_data(self):
        ...
        meter_set = [{
            "data_set":[{"eip_id":"eip-kqpkxm8f","data":[[1391945100,[23,29]],
                    [17,30],[19,29],[20,31],[22,29],[20,29],[23,30], [19,27],
                    [23,30],[16,29],[30,33],[15,29],[19,30], [23,30],[27,29],
                    [29,29],[23,29],[25,31],[34,30],[29,29],[25,33],[16,29],
                    [17,31],[17,31],[16,29],[25,28],[17,31],[21,33],[16,29],
                    [18,30],[18,31],[43,28],[43,29],[24,29],[17,31],[15,29],
                    [19,30],[19,29],[21,28],[19,31],[15,29],[15,29],[20,29],
                    [20,29],[19,31],[18,31],[18,29],[18,29],[26,31],[23,29],
                    [52,29],[21,29],[17,30],[16,29],[23,30],[22,31],[17,29],
                    [25,29],[16,29],[17,31],[16,29],[24,31],[20,29],[23,31],
                    [16,29],[17,30],[16,29],[19,31],[17,31],[17,29],[18,29],
                    [17,30]]}],
            "meter_id":"traffic"
            }]
    ...
    def test_decompress_monitoring_data(self):
        ...
        meter_set = [
                {"data":[[1391947500,[12,12]],[14,13],[16,13],[20,12],[13,13],
                    [12,12],[12,12],[13,13],[13,13],[12,12],[12,12],[16,13],
                    [14,13],[13,13],[15,13],[15,13],[12,12],[13,13],[12,12],
                    [13,13],[12,12],[13,13],[14,12],[14,12],[14,13],[18,12],
                    [15,12],[32,13],[12,12],[13,13],[15,12],[13,13],[12,12],
                    [12,12],[12,12],[14,13],[12,12],[19,13],[40,12],[39,12],
                    [13,12],[13,13],[13,13],[17,13],[12,12],[12,12],[13,13],
                    [14,13],[12,12],[15,12],[12,12],[12,12],[12,12],[12,12],
                    [14,12],[3000,[11,10]],[16,12],[15,13],[12,12],[18,15],
                    [15,12],[12,12],[13,13]],"vxnet_id":"vxnet-0",
                    "meter_id":"if-52:54:b3:0c:30:89","sequence":0
                    },
                {"data":[[1391947500,[0,2799]],[0,2441],[0,2473],[0,2320],
                    [0,2475],[0,2216],[0,2405],[0,2372],[0,2490],[0,2387],
                    [0,2492],[0,2315],[0,2834],[0,2523],[0,2287],[0,2573],
                    [0,2336],[0,2439],[0,2232],[0,2422],[0,2184],[0,2457],
                    [0,2507],[0,2368],[0,2606],[0,2459],[0,2424],[0,2456],
                    [0,2286],[0,2575],[0,2338],[0,2490],[0,2524],[0,2200],
                    [0,2406],[0,2540],[0,2406],[0,2304],[0,2424],[0,2216],
                    [0,2403],[0,2404],[0,2525],[0,2525],[0,2303],[0,2473],
                    [0,2422],[0,2341],[0,2781],[0,2406],[0,2252],[0,2320],
                    [0,2457],[0,2202],[0,2543],[3000,[921302,11145]],[0,2717],
